    ...
    <div className="container">
      <div className="row vh-100 pt-2">
        <div className="left col d-none col-12 d-lg-block col-md-2">
          ...
          <UserInfo profileData={profileData} auth={auth} refreshData={fetchData} userID={userID} />
          <Discover />
        </div>
        <div className="mid col-12 col-md-6">
          {/* mid columns go here  */}
          <CreatePost profileData={profileData} refreshData={fetchData} userID={userID} auth={auth} />

  ...
  return (
    <div className="border bg-white px-3 pt-3 round-border">
      ...
      <div className="row row-cols-1 row-cols-md-2 mt-4 border-bottom">
        <ActivityItem
          text="Game of as rest time eyes with of this it"
          image="https://picsum.photos/seed/2/30/30"
        />
        <ActivityItem
          text="Add was music merry any truth since going"
          image="https://picsum.photos/seed/3/30/30"
        />
        <ActivityItem

        ...
        <Row className="mx-auto flex-row">
          <Container className="flex-row justify-content-start">
            ...
            <Form className="my-2 mr-5">
              <InputGroup>
                <InputGroup.Prepend>
                  <InputGroup.Text id="basic-addon1"><ImSearch/></InputGroup.Text>
                </InputGroup.Prepend>
                <FormControl
                  placeholder="Search"
                  aria-label="Search"
          ...
          <Container className="ml-5 my-2">
            <ListGroup className="flex-row">
              <ListGroup.Item className="p-0 mx-2 navItems"><a href="#"><Container className="mx-3 p-0 flex-column"><AiFillHome className="navIcons"/><span className="navText">Home</span></Container></a></ListGroup.Item>
              <ListGroup.Item className="p-0 mx-2 navItems"><a href="#"><Container className="mx-3 p-0 flex-column"><FaUserFriends className="navIcons"/><span className="navText">My Network</span></Container></a></ListGroup.Item>
              <ListGroup.Item className="p-0 mx-2 navItems"><a href="#"><Container className="mx-3 p-0 flex-column"><BsFillBriefcaseFill className="navIcons"/><span className="navText">Jobs</span></Container></a></ListGroup.Item>
              <ListGroup.Item className="p-0 mx-2 navItems"><a href="#"><Container className="mx-3 p-0 flex-column"><BsFillChatDotsFill className="navIcons"/><span className="navText">Messaging</span></Container></a></ListGroup.Item>
